        ...
        <Layout>
            <div>
                ...
                <div className="md:p-16 p-8">
                    ...
                    <p className="text-center mx-auto text-gray-600 md:w-7/12 mt-2 mb-16">Discover our latest product, designed to make your life easier and more efficient. Combining modern technology with sleek design, it’s perfect for anyone looking for style and functionality in one package.</p>
                            ...
                            products.map((item, index)=>(
                                <div key={index} className="bg-white shadow-lg border">
                                    ...
                                    <div className="p-4">
                                        ...
                                        <button onClick={()=>addToCart(item)} className="bg-rose-500 py-2 w-full rounded text-white font-semibold mt-4">
